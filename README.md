...
_"Official website for coined"_

Coined is productize service business for web design, that help business to start, build, support and grow the business by offering a product that build using formula that combine website, markting, and design to lift the business profit.
...
You can see the live site [thecoined.site](https://www.thecoined.site)
...
- [Tanstack/start](https://tanstack.com/start) - for framework
